...
#from nltk.nltk_contrib.fst.draw_graph import *
from nltk.nltk_contrib.fst.draw_graph import *
...
class FST(object):
    ...
    def transduce(self, input):
        self.step_transduce(input, step=False)
        #return self.step_transduce(input, step=False).next()[1]
        #print("Test",next(self.step_transduce(input, step=False))[1])
...
class FSTDemo:
    ...
    def transduce(self, input):
        ...
        state_descr = self.fst.state_descr(self.fst.initial_state)
    ...
    def step(self, *e):
        ...
        # Perform one step.
        try: result, val = self.stepper.__next__()
